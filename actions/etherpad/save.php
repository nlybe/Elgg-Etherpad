 ...
 *
 * @package ElggPad
 * @override mod/pages/actions/pages/edit.php
 */
...
if (isIframeEnabled() && !empty($iframe_url) && !validateUrl($iframe_url)) {
    register_error(elgg_echo('etherpad:error:invalid_url'));
    forward(REFERER);   
}
...
if ($page->save()) {
    ...
    register_error(elgg_echo('etherpad:error:notsaved'));
    forward(REFERER);
}
